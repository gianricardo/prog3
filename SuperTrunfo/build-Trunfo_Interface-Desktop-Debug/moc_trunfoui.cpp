...
#include "../Trunfo_Interface/trunfoui.h"
...
static const char qt_meta_stringdata_TrunfoUI[] = {
    "TrunfoUI\0\0on_buttonPlay_clicked()\0"
};
...
const QMetaObjectExtraData TrunfoUI::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TrunfoUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TrunfoUI,
      qt_meta_data_TrunfoUI, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TrunfoUI::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TrunfoUI))
