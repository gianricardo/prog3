...
public:
    ...
    void setupUi(QDialog *escreve_nome_adversario)
    {
        ...
        escreve_nome_adversario->setStyleSheet(QStringLiteral("background-color:lightblue"));
        ...
        e_escreve_nome_adversario->setStyleSheet(QStringLiteral("background-color:white"));
